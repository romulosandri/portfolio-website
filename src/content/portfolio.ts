...
export const workItems: WorkItem[] = [
  ...
  },
  {
    ...
    duration: '9 Months',
    description:
      'Cinépolis is the third-largest cinema chain in the world. The Mexico headquarters wanted to redesign their web, mobile, and kiosk apps. I led the redesign of the mobile experience, taking it from research through high-fidelity flows that later shared a design system with web and kiosks.',
    delivered: [
      ...
      'Full design system later reused on the web and kiosk apps',
